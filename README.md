...
[发送] 写寄存器 49999 (设置内存地址)
  报文: 01 10 C3 4F 00 02 04 24 02 86 C0 XX XX
  长度: 13 字节

[接收] 写寄存器响应
  报文: 01 10 C3 4F 00 02 XX XX
  长度: 8 字节

[发送] 读寄存器 50000 (读取内存数据)
  报文: 01 03 C3 50 00 02 XX XX
  长度: 8 字节
